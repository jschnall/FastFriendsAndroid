...
public class RoundedDrawable extends Drawable {
    ...
    private float mTopLeftCornerRadius = 0;
    private float mTopRightCornerRadius = 0;
    private float mBottomLeftCornerRadius = 0;
    private float mBottomRightCornerRadius = 0;
    ...
    public void setmBottomLeftCornerRadius(float bottomLeftCornerRadius) {
    ...
    public void setmBottomRightCornerRadius(float bottomRightCornerRadius) {
